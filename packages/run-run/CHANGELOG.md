...
- [#213](https://github.com/variableland/dx/pull/213) [`6fb22e7`](https://github.com/variableland/dx/commit/6fb22e782bda665f20df7f4141842a11a40e0d0c) Thanks [@rqbazan](https://github.com/rqbazan)! - Rename `rr test:static` to `rr check`, and drop the `check` alias from `rr jsc`.
